public static class PigTypes
{
    ...
    public static PigType PorkChops = new PigType("Pork Chops", iconSpriteSheet[0], hp: 100, mana: 0, walkSpeed: 6, runSpeed: 12, undergroundSpeed: 8, jumpHeight: 18, defense: 4, damage: 2, knockback: 2, attackSpeed: 10);
    ...
    public static PigType RobinHog = new PigType("Robin Hog", iconSpriteSheet[3], hp: 100, mana: 0, walkSpeed: 8, runSpeed: 16, undergroundSpeed: 10, jumpHeight: 20, defense: 2, damage: 4, knockback: 2, attackSpeed: 12);
